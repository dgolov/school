  	...
  	<nav class="mobile-menu">
		<div class="container">
			...
			<div class="city">
				...
				<div class="select">
					<input type="radio" class="radio" id="city4" name="city2" @click="setCity('Дзержинск')"><label for="city4" class="l1">Дзержинск</label>
					<input type="radio" class="radio" id="city5" name="city2" @click="setCity('Нижний Новгород')"><label for="city5" class="l2">Нижний Новгород</label>
					<input type="radio" class="radio" id="city6" name="city2" @click="setCity('Online')"><label for="city6" class="l3">On-line</label>
				</div>
			</div>
			
			<a v-if="authenticated" href="#" class="user-link" @click="goTo('Profile', {id: user.id})"><img src="@/assets/082022/img/avatar.png"> {{ user.first_name }} {{ user.last_name }}</a>
			<span v-else>
		...
		<div class="top-page-line">
			<div class="container flex">
				...
				<div class="city">
					<a class="link">{{ $store.state.city }} <span></span></a>
					<div class="select">
						<input type="radio" class="radio" id="city1" name="city" @click="setCity('Дзержинск')"><label for="city1" class="l1">Дзержинск</label>
						<input type="radio" class="radio" id="city2" name="city" @click="setCity('Нижний Новгород')"><label for="city2" class="l2">Нижний Новгород</label>
						<input type="radio" class="radio" id="city3" name="city" @click="setCity('Online')"><label for="city3" class="l3">On-line</label>
					</div>
				</div>
