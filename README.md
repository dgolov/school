...
В системе предусмотрена crm система предоставляющая механизм отношения с клиентами и сотрудниками компании. Фронт CRM выполнен на Django Templates. Доступ к разделам системы разделен по группам сотрудников:
